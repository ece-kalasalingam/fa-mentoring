...
- Details:
  - Changed Manage Users CSV export mapping to output `fullName` and `email` as distinct fields instead of a combined `user` field.
  - Changed Manage Users PDF headers/body to include separate `Full Name` and `Email` columns.
  - Left table UI rendering unchanged: the on-screen `User` column still displays full name and email together in one cell.
- Revert: none

## 2026-05-23 05:28 IST | codex | change
- Summary: Replaced favicon/logo asset set with files from `spris_iconset_webapp.zip` and aligned manifest/browserconfig paths for `/favicons`.
- Files: frontend/public/favicons/android-chrome-1024x1024.png, frontend/public/favicons/android-chrome-144x144.png, frontend/public/favicons/android-chrome-192x192.png, frontend/public/favicons/android-chrome-256x256.png, frontend/public/favicons/android-chrome-36x36.png, frontend/public/favicons/android-chrome-384x384.png, frontend/public/favicons/android-chrome-48x48.png, frontend/public/favicons/android-chrome-512x512.png, frontend/public/favicons/android-chrome-72x72.png, frontend/public/favicons/android-chrome-96x96.jpg, frontend/public/favicons/android-chrome-96x96.png, frontend/public/favicons/apple-touch-icon-114x114-precomposed.png, frontend/public/favicons/apple-touch-icon-114x114.png, frontend/public/favicons/apple-touch-icon-120x120-precomposed.png, frontend/public/favicons/apple-touch-icon-120x120.png, frontend/public/favicons/apple-touch-icon-144x144-precomposed.png, frontend/public/favicons/apple-touch-icon-144x144.png, frontend/public/favicons/apple-touch-icon-152x152-precomposed.png, frontend/public/favicons/apple-touch-icon-152x152.png, frontend/public/favicons/apple-touch-icon-180x180-precomposed.png, frontend/public/favicons/apple-touch-icon-180x180.png, frontend/public/favicons/apple-touch-icon-57x57-precomposed.png, frontend/public/favicons/apple-touch-icon-57x57.png, frontend/public/favicons/apple-touch-icon-60x60-precomposed.png, frontend/public/favicons/apple-touch-icon-60x60.png, frontend/public/favicons/apple-touch-icon-72x72-precomposed.png, frontend/public/favicons/apple-touch-icon-72x72.png, frontend/public/favicons/apple-touch-icon-76x76-precomposed.png, frontend/public/favicons/apple-touch-icon-76x76.png, frontend/public/favicons/apple-touch-icon-precomposed.png, frontend/public/favicons/apple-touch-icon.png, frontend/public/favicons/browserconfig.xml, frontend/public/favicons/favicon-16x16.png, frontend/public/favicons/favicon-32x32.png, frontend/public/favicons/favicon-48x48.png, frontend/public/favicons/favicon.ico, frontend/public/favicons/html-head-snippet.txt, frontend/public/favicons/icon-128x128.png, frontend/public/favicons/icon-144x144.png, frontend/public/favicons/icon-152x152.png, frontend/public/favicons/icon-384x384.png, frontend/public/favicons/icon-72x72.png, frontend/public/favicons/icon-96x96.png, frontend/public/favicons/icon-master-1024.png, frontend/public/favicons/mstile-144x144.png, frontend/public/favicons/mstile-150x150.png, frontend/public/favicons/mstile-310x150.png, frontend/public/favicons/mstile-310x310.png, frontend/public/favicons/mstile-70x70.png, frontend/public/favicons/safari-pinned-tab.svg, frontend/public/favicons/site.webmanifest, frontend/public/favicons/spris-logo.svg, CHANGELOG.md
- Details:
  - Replaced favicon directory image assets with the provided zip set and removed legacy files not present in the new set.
  - Added compatibility files `android-chrome-1024x1024.png` (from `icon-master-1024.png`) and `mstile-144x144.png` (from `icon-144x144.png`) so existing frontend favicon/logo references remain valid.
  - Updated `site.webmanifest` branding and icon `src` values to `FA-Mentoring` and `/favicons/...` paths.
  - Updated `browserconfig.xml` tile logo path to `/favicons/mstile-150x150.png`.
  - Updated `html-head-snippet.txt` heading text to `FA-Mentoring`.
- Revert: none
